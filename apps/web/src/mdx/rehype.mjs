    ...
    h(
      ...
      lines.map((line, index) => {
        ...
        if (
          ...
          line?.some(
            token => token.content === 'neopilot' && token.color === 'var(--shiki-token-text)'
          ) // works fine for Python and JS
        ) {
          isNeopilotImport = true // TODO: Actually use, probably to dim the line
        }
