...
async function isValidPath(pathname: string) {
  try {
    ...
    const targetUrl = `https://neopilot.dev${pathname}`
...
export async function generateMetadata() {
  ...
  const shouldIndex = headerList.get('x-neopilot-should-index')
  ...
  return {
    title: {
      template: '%s - NEOPILOT',
      default: 'NEOPILOT - Code Interpreting for AI apps',
    },
    description: 'Open-source secure sandboxes for AI code execution',
    twitter: {
      title: 'NEOPILOT - Code Interpreting for AI apps',
      description: 'Open-source secure sandboxes for AI code execution',
    },
    openGraph: {
      title: 'NEOPILOT - Code Interpreting for AI apps',
    ...
    alternates:
      isValid && pathname !== ''
        ? {
            canonical: `https://neopilot.dev${pathname}`,
          }
        : undefined,
    robots:
      isValid && shouldIndex
