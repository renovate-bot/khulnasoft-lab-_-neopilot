...
You can use NEOPILOT Sandbox to run AI-generated code to analyze data. Here's how the AI data analysis workflow usually looks like:
...
## Example: Analyze CSV file with NEOPILOT and Claude 3.5 Sonnet
This short example will show you how to use NEOPILOT Sandbox to run AI-generated code to analyze CSV data.
...
Install the NEOPILOT SDK and Claude SDK to your project by running the following command in your terminal.

<CodeGroup isTerminalCommand>
```bash {{ language: 'js' }}
npm i @neopilot/code-interpreter @anthropic-ai/sdk dotenv
```
```bash {{ language: 'python' }}
pip install neopilot-code-interpreter anthropic python-dotenv
```
</CodeGroup>

### 2. Set your API keys
1. Get your NEOPILOT API key from [NEOPILOT Dashboard](/dashboard?tab=keys).
