...
import imgModel from '@/images/ai-app-neopilot-sandbox-model.png'
import { Check } from 'lucide-react'

import { features } from './features'

# Overview
**The NEOPILOT's sandboxes are isolated cloud environments made specifcially for AI code interpreting or code execution.**

The NEOPILOT sandboxes are an ideal fit as a playground for AI assistants like coding copilots, code interpreters, AI data analysts, AI browser assistants, and other AI-powered apps.
...
<Image
  ...
  alt="Separate NEOPILOT Sandbox for each instance of your AI app"
  unoptimized
/>

NEOPILOT Sandboxes are made exactly to solve these challenges. The sandbox is like an isolated runtime or playground for the LLM. **We give you our SDK to spawn and control these sandboxes.**
...
To start and control the sandbox, use the [NEOPILOT SDK](/docs/getting-started/installation) for Python or JavaScript.
...
<Note>
Make sure you have the `NEOPILOT_API_KEY` environment variable set with your [API key](/docs/getting-started/api-key).
</Note>
