...
// or use Core: https://github.com/khulnasoft-lab/neopilot
// import { Sandbox } from 'neopilot'
//
// or use Desktop: https://github.com/khulnasoft-lab/desktop
// import { Sandbox } from '@neopilot/desktop'
...
#
# or use Desktop: https://github.com/khulnasoft-lab/desktop
# from neopilot_desktop import Sandbox
...
<CodeGroup>
```js
import { Sandbox, SandboxInfo } from '@neopilot/code-interpreter'
// or use Core: https://github.com/khulnasoft-lab/neopilot
// import { Sandbox, SandboxInfo } from 'neopilot'
//
// or use Desktop: https://github.com/khulnasoft-lab/desktop
// import { Sandbox, SandboxInfo } from '@neopilot/desktop'
...
```
```python
from neopilot_code_interpreter import Sandbox, SandboxListQuery
# or use Core: https://github.com/khulnasoft-lab/neopilot
# from neopilot import Sandbox, SandboxListQuery
#
# or use Desktop: https://github.com/khulnasoft-lab/desktop
# from neopilot_desktop import Sandbox, SandboxInfo, SandboxListQuery
...
## Sandbox's timeout
When you resume a sandbox, the sandbox's timeout is reset to the default timeout of an NEOPILOT sandbox - 5 minutes.
