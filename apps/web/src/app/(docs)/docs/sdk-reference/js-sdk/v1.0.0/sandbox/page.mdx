...
```ts
NEOPILOT_ACCESS_TOKEN // environment variable
```
...
```ts
NEOPILOT_API_KEY // environment variable
```
...
NEOPILOT_DEBUG // environment variable or `false`
...
NEOPILOT_DOMAIN // environment variable or `neopilot.dev`
