...
- `api_key`: API key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
...
- `api_key`: NEOPILOT API Key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
- `request_timeout`: Timeout for the request in **seconds**
...
- `sandbox_id`: Sandbox ID
- `api_key`: NEOPILOT API Key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
- `domain`: NEOPILOT domain to use for authentication, defaults to `NEOPILOT_DOMAIN` environment variable
- `debug`: Whether to use debug mode, defaults to `NEOPILOT_DEBUG` environment variable
- `request_timeout`: Timeout for the request in **seconds**
