...
- `debug`: If True, the sandbox will be created in debug mode, defaults to `NEOPILOT_DEBUG` environment variable
- `sandbox_id`: Sandbox ID to connect to, defaults to `NEOPILOT_SANDBOX_ID` environment variable
