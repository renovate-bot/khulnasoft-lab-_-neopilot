    ...
    <div className="flex flex-col w-full items-center justify-between gap-5 pt-8 dark:border-white/5 sm:flex-row">
      <div className="flex flex-col items-center justify-start lg:items-start">
        <p className="text-xs text-zinc-600 dark:text-zinc-400">
          &copy; KhulnaSoft, Lab {new Date().getFullYear()}. All rights
          reserved.
        </p>
      </div>
      <div className="flex gap-4">
        <SocialLink href="https://x.com/neopilot" icon={TwitterIcon}>
          Follow us on X (f.k.a. Twitter)
        </SocialLink>
        <SocialLink href="https://github.com/khulnasoft-lab" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
