...
const items: BoxItem[] = [
  {
    ...
    description: 'Learn how to use NEOPILOT run AI-generated code to analyze yourdata.',
  ...
  },
  {
    ...
    description: 'Create interactive charts by running Python code in NEOPILOT.',
