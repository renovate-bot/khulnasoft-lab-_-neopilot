...
from neopilot.sandbox.sandbox_api import SandboxInfo, SandboxApiBase, SandboxQuery, ListedSandbox
from neopilot.exceptions import TemplateException
from neopilot.api import AsyncApiClient, SandboxCreateResponse
from neopilot.api.client.models import NewSandbox, PostSandboxesSandboxIDTimeoutBody
from neopilot.api.client.api.sandboxes import (
...
from neopilot.api import handle_api_exception
...
class SandboxApi(SandboxApiBase):
    ...
    async def list(
        ...
        :param api_key: API key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
    ...
    async def _cls_get_info(
        ...
        :param api_key: API key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
        :param domain: Domain to use for the request, defaults to `NEOPILOT_DOMAIN` environment variable
        :param debug: Debug mode, defaults to `NEOPILOT_DEBUG` environment variable
        :param request_timeout: Timeout for the request in **seconds**
        :param headers: Additional headers to send with the request
        :param proxy: Proxy to use for the request
