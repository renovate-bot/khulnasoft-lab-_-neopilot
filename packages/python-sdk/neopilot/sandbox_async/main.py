...
from neopilot.api.client.types import Unset
from neopilot.connection_config import ConnectionConfig, ProxyTypes
from neopilot.envd.api import ENVD_API_HEALTH_ROUTE, ahandle_envd_api_exception
from neopilot.exceptions import format_request_timeout_error
from neopilot.sandbox.main import SandboxSetup
from neopilot.sandbox.utils import class_method_variant
from neopilot.sandbox_async.filesystem.filesystem import Filesystem
from neopilot.sandbox_async.commands.command import Commands
from neopilot.sandbox_async.commands.pty import Pty
from neopilot.sandbox_async.sandbox_api import SandboxApi, SandboxInfo
...
class AsyncSandbox(SandboxSetup, SandboxApi):
    """
    NEOPILOT cloud sandbox is a secure and isolated cloud environment.
    ...
    Check docs [here](https://neopilot.dev/docs).

    Use the `AsyncSandbox.create()` to create a new sandbox.

    Example:
    ```python
    from neopilot import AsyncSandbox
    ...
    async def create(
        ...
        :param api_key: NEOPILOT API Key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
        :param request_timeout: Timeout for the request in **seconds**
    ...
    async def get_info(
        ...
        :param sandbox_id: Sandbox ID
        :param api_key: NEOPILOT API Key to use for authentication, defaults to `NEOPILOT_API_KEY` environment variable
        :param domain: NEOPILOT domain to use for authentication, defaults to `NEOPILOT_DOMAIN` environment variable
        :param debug: Whether to use debug mode, defaults to `NEOPILOT_DEBUG` environment variable
        :param request_timeout: Timeout for the request in **seconds**
