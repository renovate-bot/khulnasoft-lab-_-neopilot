...
from neopilot.sandbox.filesystem.filesystem import WriteEntry
import neopilot_connect as connect
from neopilot.connection_config import (
    ConnectionConfig,
    Username,
    KEEPALIVE_PING_HEADER,
    KEEPALIVE_PING_INTERVAL_SEC,
)
from neopilot.envd.api import ENVD_API_FILES_ROUTE, ahandle_envd_api_exception
from neopilot.envd.filesystem import filesystem_connect, filesystem_pb2
from neopilot.envd.rpc import authentication_header, handle_rpc_exception
from neopilot.envd.versions import ENVD_VERSION_RECURSIVE_WATCH
from neopilot.exceptions import SandboxException, TemplateException, InvalidArgumentException
from neopilot.sandbox.filesystem.filesystem import EntryInfo, map_file_type
from neopilot.sandbox.filesystem.watch_handle import FilesystemEvent
from neopilot.sandbox_async.filesystem.watch_handle import AsyncWatchHandle
from neopilot.sandbox_async.utils import OutputHandler
...
class Filesystem:
    ...
    def __init__(
        ...
        self._rpc = filesystem_connect.FilesystemClient(
            ...
            # compressor=neopilot_connect.GzipCompressor,
            async_pool=pool,
            json=True,
    ...
    async def watch_dir(
        ...
        if (
            ...
            raise TemplateException(
                ...
                "You can do this by running `neopilot template build` in the directory with the template."
            )
