...
import neopilot_connect
import httpcore
import httpx
from packaging.version import Version

from neopilot.envd.versions import ENVD_VERSION_RECURSIVE_WATCH
from neopilot.exceptions import TemplateException, InvalidArgumentException
...
from neopilot.envd.api import ENVD_API_FILES_ROUTE, handle_envd_api_exception
...
from neopilot.sandbox_sync.filesystem.watch_handle import WatchHandle
...
class Filesystem:
    ...
    def exists(
        ...
        try:
            ...
            if isinstance(e, neopilot_connect.ConnectException):
                if e.status == neopilot_connect.Code.not_found:
                    return False
            raise handle_rpc_exception(e)
    ...
    def make_dir(
        ...
        try:
            ...
            if isinstance(e, neopilot_connect.ConnectException):
                if e.status == neopilot_connect.Code.already_exists:
                    return False
            raise handle_rpc_exception(e)
