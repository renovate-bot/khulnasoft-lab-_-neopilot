...
class ConnectionConfig:
    ...
    @staticmethod
    def _domain():
        return os.getenv("NEOPILOT_DOMAIN") or "neopilot.app"

    @staticmethod
    def _debug():
        return os.getenv("NEOPILOT_DEBUG", "false").lower() == "true"

    @staticmethod
    def _api_key():
        return os.getenv("NEOPILOT_API_KEY")

    @staticmethod
    def _access_token():
        return os.getenv("NEOPILOT_ACCESS_TOKEN")
